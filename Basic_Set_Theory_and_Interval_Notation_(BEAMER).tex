...
\end{tikzpicture}
\\
\hline $[4, \, 9]$ & $\lbrace x \mid 4\leq x \leq 9 \rbrace$ & \begin{tikzpicture}[baseline=(current bounding box.north)]
    \coordinate (A) at (0,0);
    \coordinate (B) at (2,0);
    \draw [<->, >=stealth] (-1,0) -- (3,0);
    \node at (A) [anchor = north] {$4$};
...
\end{tikzpicture}
\\
\hline $[4, \, 9)$ & $\lbrace x \mid 4 \leq x < 9 \rbrace$ & \begin{tikzpicture}[baseline=(current bounding box.north)]
    \coordinate (A) at (0,0);
    \coordinate (B) at (2,0);
    \draw [<->, >=stealth] (-1,0) -- (3,0);
    \node at (A) [anchor = north] {$4$};
...
\end{tikzpicture} 
\\
\hline $(4, \, 9]$ & $\lbrace x \mid 4 < x \leq 9 \rbrace$ & \begin{tikzpicture}[baseline=(current bounding box.north)]
    \coordinate (A) at (0,0);
    \coordinate (B) at (2,0);
    \draw [<->, >=stealth] (-1,0) -- (3,0);
    \node at (A) [anchor = north] {$4$};
...
\begin{tabular}{|c|c|c|}
\hline \textbf{Interval Notation} & \textbf{Set-Builder Notation} & \textbf{Graph} \\[5pt] 
\hline $(4, \, \infty)$ & $\lbrace x \mid x > 4 \rbrace$ & \begin{tikzpicture}[baseline=(current bounding box.north)]
    \coordinate (A) at (0,0);
    \coordinate (B) at (2,0);
    \draw [<->, >=stealth] (-1,0) -- (3,0);
    \node at (A) [anchor = north] {$4$};
...
\hline $[4, \, \infty)$ & $\lbrace x \mid x \geq 4 \rbrace$ & \begin{tikzpicture}[baseline=(current bounding box.north)]
    \coordinate (A) at (0,0);
    \coordinate (B) at (2,0);
    \draw [<->, >=stealth] (-1,0) -- (3,0);
    \node at (A) [anchor = north] {$4$};
...
\hline $(-\infty, \, 9)$ & $\lbrace x \mid x < 9 \rbrace$ & \begin{tikzpicture}[baseline=(current bounding box.north)]
    \coordinate (A) at (0,0);
    \coordinate (B) at (2,0);
    \draw [<->, >=stealth] (-1,0) -- (3,0);
    \node at (B) [anchor = north] {$9$};
...
\hline $(-\infty, \, 9]$ & $\lbrace x \mid x \leq 9 \rbrace$ & \begin{tikzpicture}[baseline=(current bounding box.north)]
    \coordinate (A) at (0,0);
    \coordinate (B) at (2,0);
    \draw [<->, >=stealth] (-1,0) -- (3,0);
    \node at (B) [anchor = north] {$9$};
