...
\usepackage{amsmath, xcolor, tikz, pgfplots, array, tcolorbox}
...
\begin{tabular}{c|c|c}
    ...
    $f(x)$      &  \onslide<4->{\color{red}$(-\infty,\infty)$}  &  \onslide<6->{\color{blue}$(-\infty,\infty)$}                   \\[6pt] \hline
    $f^{-1}(x)$ & \onslide<7->{\color{blue}$(-\infty,\infty)$}  & \onslide<5->{\color{red}$(-\infty,\infty)$}                  \\[6pt]
\end{tabular}}
\end{center}
\begin{align*}
...
\begin{tabular}{c|c|c}
                &  \textbf{Domain}  &   \textbf{Range}  \\      \hline
    $g(x)$      &  \onslide<4->{\color{red}$x \neq 1$}  &  \onslide<7->{\color{blue}$y \neq -2$}                   \\[6pt] \hline
    $g^{-1}(x)$ & \onslide<6->{\color{blue}$x \neq -2$}  & \onslide<5->{\color{red}$y \neq 1$}                  \\[6pt]
\end{tabular}}
\end{center}
\begin{align*}
...
\begin{tabular}{c|c|c}
                &  \textbf{Domain}  &   \textbf{Range}  \\      \hline
    $h(x)$      &  \onslide<4->{\color{red}$x \geq -2$}  &  \onslide<6->{\color{blue}$y \geq -1$}                   \\[6pt] \hline
    $h^{-1}(x)$ & \onslide<7->{\color{blue}$x \geq -1$}  & \onslide<5->{\color{red}$y \geq -2$}                  \\[6pt]
\end{tabular}}
\end{center}
\begin{align*}
...
\begin{tabular}{c|c|c}
                &   \textbf{Domain}             &   \textbf{Range}              \\ \hline 
    $j(x)$      & \onslide<3->{$x \leq 1$}      & \onslide<6->{$y \geq 3$}      \\[5pt] \hline
    $j^{-1}(x)$ & \onslide<5->{$x \geq 3$}      & \onslide<4->{$y \leq 1$}      \\[5pt]
\end{tabular}}
\end{center}
\begin{align*}
