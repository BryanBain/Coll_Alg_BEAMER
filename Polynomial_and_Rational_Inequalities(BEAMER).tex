...
\onslide<5->{\draw[color=blue, fill=blue] (-1.5,0) circle [radius=2.5pt];}
\onslide<5->{\draw[color=blue, fill=white] (1.5,0) circle [radius=2.5pt];}
\onslide<6->{\draw[color=blue, ultra thick, shorten >= 2.5pt] (-1.5,0) -- (1.5,0);}
\end{tikzpicture}}
\end{center}
...
\[ \frac{-3x+2}{x+1} > 0 \]
\begin{align*}
    \onslide<2->{-3x+2&=0 & x+1&=0} \\[4pt]
    \onslide<3->{x&=\frac{2}{3} & x&=-1} \\
\end{align*}
\begin{center}
\onslide<4->{\begin{tikzpicture}
\draw[<->] (-2.5,0) -- (2.5,0);
...
\onslide<5->{\draw[color=blue, fill=white] (-1.5,0) circle [radius=2.5pt];}
\onslide<5->{\draw[color=blue, fill=white] (1.5,0) circle [radius=2.5pt];}
\onslide<6->{\draw[color=blue, ultra thick, shorten <= 2.5pt, shorten >= 2.5pt] (-1.5,0) -- (1.5,0);}
\end{tikzpicture}}
\end{center}
\onslide<7->{\[\left(-1, \frac{2}{3}\right)\]}
\end{frame}
...
\begin{align*}
    \onslide<2->{\frac{x+2}{x-3} &= 2x-2} \\[8pt]
    \onslide<3->{\frac{x+2}{x-3} &= \frac{(2x-2)(x-3)}{x-3}} \\[8pt]
